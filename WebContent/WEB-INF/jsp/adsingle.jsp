		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="${pageContext.request.contextPath}/statics/images/aads2.png">
							<div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/aads2.png" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>详细介绍</i></h5>
					<p> Adidas/阿迪达斯功能: 减震 防滑 耐磨 透气 包裹性 支撑 平衡 抗冲击 轻便 回弹
					鞋码: 36 36.5 37 38 38.5 39 40 40.5 41 42 42.5 43 44 44.5 45
					颜色分类: CP9366/白冰淇淋吊牌价: 1899款号: cp9366*%上市时间: 2019年秋季</p>
				</div>
