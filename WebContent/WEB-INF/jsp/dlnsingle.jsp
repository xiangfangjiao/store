		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="${pageContext.request.contextPath}/statics/images/六爪镶嵌钻戒.jpg">
							<div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/六爪镶嵌钻戒.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="${pageContext.request.contextPath}/statics/images/六爪镶嵌钻戒2.jpg">
							 <div class="thumb-image"> <img src="六爪镶嵌钻戒2" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>详细介绍</i></h5>
					<p>戒指 六爪镶嵌钻戒 生产地 美国 无色钻石 
					项链 ELSA PERETTI心形项链 生产地 美国18k黄金，无色钻石，心形
 					手镯 ELSA PERETTI Diamonds by the Yard™ 手链
					生产地 美国 蓝色纯银蓝宝石，总重0.06克拉</p>
				</div>
