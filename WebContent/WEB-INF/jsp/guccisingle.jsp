		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="${pageContext.request.contextPath}/statics/images/gucci1.jpg">
							<div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/gucci1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>详细介绍</i></h5>
					<p>古奇Gucci/古奇系列: 448065质地: 牛皮皮革材质: 牛皮颜
					色分类: 奶茶色 红色上市时间: 2020年春季
					货号: DTD1T 5729背包方式: 单肩斜挎款式: 单肩包
					大小: 小流行款式名称: 小方包</p>
				</div>
