		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="${pageContext.request.contextPath}/statics/images/kouchi1.jpg">
							<div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/kouchi1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="${pageContext.request.contextPath}/statics/images/kouchi2.jpg">
							 <div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/kouchi2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>详细介绍</i></h5>
					<p> COACH/蔻驰coach系列: 54070质地: 牛皮皮革材质: 牛皮革
					颜色分类: 海军蓝色	B4BHP上市时间: 2020年夏季货号: 54070
					背包方式: 单肩斜挎款式: 单肩包大小: 小流行款式名称: 其他</p>
				</div>
