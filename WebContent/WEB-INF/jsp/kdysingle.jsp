		...
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="${pageContext.request.contextPath}/statics/images/钻戒.jpg">
						   <div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/钻戒.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>详细介绍</i></h5>
					<p>钻戒钻石系列B4210700 生产地  法国  项链 DIAMANTS LÉGERS系列 生产地  法国
						手镯 LOVE系列 生产地  法国</p>
				</div>
