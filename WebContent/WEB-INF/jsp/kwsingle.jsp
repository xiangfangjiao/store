		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="${pageContext.request.contextPath}/statics/images/kw1.jpg">
							<div class="thumb-image"> <img src="${pageContext.request.contextPath}/statics/images/kw1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>详细介绍</i></h5>
					<p> Converse/匡威鞋码: 35 36 36.5 37 37.5 38 39 39.5 40 41 41.5 42 42.5 43 44
					颜色分类: 162050C/三星标黑高 164944C/三星标红高 164945C/三星标黑蓝高 162052C/三星
					标军绿高 162054C/三星标黄高吊牌价: 439款号: 101001@上市时间: 2019年夏季鞋帮高度: 低帮
					性别: 男女通用是否商场同款: 是</p>
				</div>
