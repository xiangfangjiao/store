...
<body> 
	...
	<div class="typo codes">
		<div class="container"> 
			<h3 class="agileits-title">会员专享</h3>
			<div class="grid_3 grid_4">
				<h3 class="w3ls-hdg">会员专享优惠商品</h3>
			</div>
			<!-- new-products -->
		...
		<div class="container">
			...
			<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<div class="simpleCart_shelfItem">
									<p><span>$180</span> <i class="item_price">$135</i></p>
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="${pageContext.request.contextPath}/statics/images/ysl7.jpg" alt=" " class="img-responsive" />
									<div>
										<ul>
											<li>
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/guccisingle">gucci女包</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/mksingle">mk女包</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/kcsingle">蔻驰女包</a></h5> 
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/nksingle">nike球鞋</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/adsingle">阿迪达斯鞋</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>$210</span> <i class="item_price">$160</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/kwsingle">匡威鞋</a></h5> 
								<div class="simpleCart_shelfItem">
									<p><span>$896</span> <i class="item_price">$809</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/dlnsingle">蒂芙尼首饰</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="${pageContext.request.contextPath}/client/glfsingle">格拉夫首饰</a></h5>
								<div class="simpleCart_shelfItem">
