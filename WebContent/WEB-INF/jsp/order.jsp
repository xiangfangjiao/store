                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
                        ...
                        <c:forEach items="${order}" var="order">
                            <tr>
                                ...
                                <td>${order.goods.proName}</td>
                                <td>${order.address}</td>
                                <td>${order.total}</td>
                                <td>${order.date}</td>
                             <c:choose>
            						<c:when test="${order.isornotpay==0}">
            						<td class="center">已付款 未发货</td>
            						</c:when>
            						<c:when test="${order.isornotpay==1}">
            						<td class="center">已付款 出货中</td>
            						</c:when>
            						<c:otherwise>
            						<td class="center">已付款 已完成</td>
            						</c:otherwise>
            					</c:choose>
