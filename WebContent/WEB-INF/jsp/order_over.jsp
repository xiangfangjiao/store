                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
                        ...
                        <c:forEach items="${orders}" var="orders">
                            <tr>
                                ...
                                <td>${orders.total}</td>
                               <c:choose>
            						<c:when test="${orders.isornotpay==1}">
            						<td class="center">已付款<a href="${pageContext.request.contextPath}/order_over_shield/${orders.oid }">已发货</a></td>
            						</c:when>
            						<c:otherwise>
            						<td class="center">已付款<a href="">已完成</a></td>
            						</c:otherwise>
            					</c:choose>
                                <td>${orders.payway}</td>
                            </tr>
