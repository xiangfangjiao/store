...
<div id="rightSide">
    ...
    <div class="line"></div>
       ...
       <c:forEach items="${goodsmsg}" var="goodsmsg">
        <form class="form" method="post"  action="${pageContext.request.contextPath}/goodsMessage/${goodsmsg.proId }">
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="${pageContext.request.contextPath}/statics/image/icons/dark/alert.png" alt="" class="titleIcon" /><h6>修改商品信息</h6>${error}</div>
                    
                    <div class="formRow">
                        <label >商品名称：<span class="req">*</span></label>
                        <div class="formRight">
                        <input value="${goodsmsg.proName}" type="text" name="numsValid" id="numsValid"/>
                        </div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <label >商品图片：<span class="req">*</span></label>
                        <div class="formRight"><p><img src="${pageContext.request.contextPath}/statics/file/${goodsmsg.photo}" style="display:none;" id="preview"/></p>
						<input  type="file" name="photo" onchange="viewImage(this)" required="required" />   				 				
					 </div>
                    <div class="formRow">
                        <label >品牌：<span class="req">*</span></label>
                        <div class="formRight">
                        <input value="${goodsmsg.brand}" type="text"  name="ipValid" id="ipValid"/></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <label>国家：<span class="req">*</span></label>
                        <div class="formRight">
                        <input value="${goodsmsg.country}" type="text" name="emailValid" id="emailValid"/></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <label >单价：<span class="req">*</span></label>
                        <div class="formRight">
                        <input value="${goodsmsg.price}" type="text"  name="dateValid" id="dateValid"/></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <div class="floatL">
                                <select name="category.categoryId" id="selectReq" class="validate[required]" >
                                  <c:forEach items="${goodsmsg.category}" var="category">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                        <textarea  rows="8" cols="" name="textarea" class="validate[required]" id="textareaValid"></textarea></div><div class="clear"></div>
                    </div>
