...
<!-- for bootstrap working -->
	...
	<!-- //for bootstrap working -->
	<!-- header modal --><h4 class="modal-title" id="myModalLabel">别着急，密码马上回来！</h4>
						...
						<div class="col-md-8 modal_body_left modal_body_left1" style="border-right: 1px dotted #C2C2C2;padding-right:3em;">
							<div class="sap_tabs">	
								<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
											...
											<div class="register">
											<form action="${pageContext.request.contextPath}/client/wangpsw" method="post">
                    								<form:errors path="userPsw" cssStyle="color:red;"/>
													<input name="userEmail" placeholder="邮箱" type="text" required="required"/>
													<input type="password" placeholder="新密码" id="newUserPsw" name="newUserPsw"/>	<br/>
													<input type="password" placeholder="确认密码"  id="rNewUserPsw" name="rNewUserPsw"/>								
													<div class="sign-up">
														<input type="submit" value="修改密码"/>&nbsp;&nbsp;
														&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/logins">返回</a>
													</div>
												</form>
